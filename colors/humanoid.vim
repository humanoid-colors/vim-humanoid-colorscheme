...
call <sid>hi("Conceal",       s:gui05, s:guiBG, s:cterm05, s:ctermBG, "", "")
...
call <sid>hi("Keyword",      s:gui0C, "", s:cterm0C, "", "", "")
...
" Diff highlighting
call <sid>hi("DiffAdd",       s:gui0B, "", s:cterm0B, "", "inverse", "")
call <sid>hi("DiffChange",    s:gui03, "", s:cterm03, "", "inverse", "")
call <sid>hi("DiffDelete",    s:gui08, "", s:cterm08, "", "inverse", "")
call <sid>hi("DiffText",      s:gui0D, "", s:cterm0D, "", "inverse", "")
call <sid>hi("DiffAdded",     s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("DiffChanged",   s:gui0C, "", s:cterm0C, "", "", "")
call <sid>hi("DiffFile",      s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("DiffNewFile",   s:gui09, "", s:cterm09, "", "", "")
